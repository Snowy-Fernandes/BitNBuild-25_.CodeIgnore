...
export default function CustomRecipeScreen() {
  ...
  const loadOptions = async () => {
    try {
      ...
      const response = await fetch('http://localhost:5000/api/custom-recipe/options');
  ...
  const handleFinalGenerate = async () => {
    ...
    try {
      // FIXED: Correct endpoint URL
      const response = await fetch('http://localhost:5000/api/custom-recipe/generate-recipe', {
        method: 'POST',
        headers: {
